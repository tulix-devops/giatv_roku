...
sub buildNavigationItems()
    ...
    print "VerticalNavigationBar.brs - [buildNavigationItems] Navigation data count: " + navigationData.Count().ToStr()
    print "VerticalNavigationBar.brs - [buildNavigationItems] Listing all items:"
    for i = 0 to navigationData.Count() - 1
        if navigationData[i] <> invalid
            ...
            print "VerticalNavigationBar.brs - [buildNavigationItems]   [" + i.ToStr() + "] id=" + itemId + ", title=" + itemTitle
        end if
    end for
    ...
    if m.navigationRowList <> invalid
        ...
        m.navigationRowList.jumpToRowItem = [0, 0]
        print "VerticalNavigationBar.brs - [buildNavigationItems] Built " + navigationData.Count().ToStr() + " items"
    end if
