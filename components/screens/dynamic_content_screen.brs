                ...
                if selectedItem <> invalid
                    ...
                    if selectedItem.dvr_url <> invalid and selectedItem.dvr_url <> ""
                        ...
                        if selectedItem.apiData <> invalid
                            print "DynamicContentScreen.brs - [onItemSelected] ✓ apiData exists, checking for stream URL"
                            print "DynamicContentScreen.brs - [onItemSelected] apiData type: " + Type(selectedItem.apiData)
                            
                            ' Debug: Show what's in apiData
                            if m.top.contentTypeId = 14
                                print "DynamicContentScreen.brs - [onItemSelected] DEBUG: apiData contents:"
                                apiDataInterface = GetInterface(selectedItem.apiData, "ifAssociativeArray")
                                if apiDataInterface <> invalid
                                    for each key in selectedItem.apiData.Keys()
                                        value = selectedItem.apiData[key]
                                        if value = invalid
                                            print "DynamicContentScreen.brs - [onItemSelected]   " + key + ": <invalid>"
                                        else
                                            valueType = Type(value)
                                            if valueType = "roString" or valueType = "String"
                                                print "DynamicContentScreen.brs - [onItemSelected]   " + key + ": """ + value + """"
                                            else
                                                print "DynamicContentScreen.brs - [onItemSelected]   " + key + ": [" + valueType + "]"
                                            end if
                                        end if
                                    end for
                                end if
                            ...
                            if selectedItem.apiData.sources <> invalid
                                print "DynamicContentScreen.brs - [onItemSelected] ✓ apiData.sources exists"
                                
                                if selectedItem.apiData.sources.primary <> invalid
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.primary = """ + selectedItem.apiData.sources.primary + """"
                                    if selectedItem.apiData.sources.primary <> ""
                                    ...
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.primary is invalid"
                                end if
                                
                                if contentUrl = "" and selectedItem.apiData.sources.hls <> invalid
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.hls = """ + selectedItem.apiData.sources.hls + """"
                                    if selectedItem.apiData.sources.hls <> ""
                                    ...
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.hls is invalid or empty"
                                end if
                                
                                if contentUrl = "" and selectedItem.apiData.sources.secondary <> invalid
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.secondary = """ + selectedItem.apiData.sources.secondary + """"
                                    if selectedItem.apiData.sources.secondary <> ""
                                    ...
                                    print "DynamicContentScreen.brs - [onItemSelected] apiData.sources.secondary is invalid or empty"
                                end if
                            else
                                print "DynamicContentScreen.brs - [onItemSelected] ✗ apiData.sources is invalid"
                            end if
                            ...
                            print "DynamicContentScreen.brs - [onItemSelected] ✗ apiData is invalid (not present on item)"
                        end if
                        ...
                        if contentUrl = ""
                            print "DynamicContentScreen.brs - [onItemSelected] ❌ ERROR: Content URL: No URL found"
                            print "DynamicContentScreen.brs - [onItemSelected] ========== URL SEARCH SUMMARY =========="
                            print "DynamicContentScreen.brs - [onItemSelected] Checked the following fields (all empty or invalid):"
                            print "DynamicContentScreen.brs - [onItemSelected]   1. apiData.sources.primary"
                            print "DynamicContentScreen.brs - [onItemSelected]   2. apiData.sources.hls"
                            print "DynamicContentScreen.brs - [onItemSelected]   3. apiData.sources.secondary"
                            print "DynamicContentScreen.brs - [onItemSelected]   4. apiData.url"
                            print "DynamicContentScreen.brs - [onItemSelected]   5. apiData.stream_url"
                            print "DynamicContentScreen.brs - [onItemSelected]   6. url"
                            print "DynamicContentScreen.brs - [onItemSelected]   7. hls"
                            print "DynamicContentScreen.brs - [onItemSelected]   8. stream_url"
                            print "DynamicContentScreen.brs - [onItemSelected]   9. sources.hls"
                            print "DynamicContentScreen.brs - [onItemSelected]   10. sources.primary"
                            print "DynamicContentScreen.brs - [onItemSelected] ============================================"
                        else
